package ru.sberbank.lesson6.task.room;
...
import ru.sberbank.lesson6.task.room.adapters.NoteAdapter;
import ru.sberbank.lesson6.task.room.dao.NoteViewModel;

import static ru.sberbank.lesson6.task.room.adapters.NoteAdapter.noteColor;
import static ru.sberbank.lesson6.task.room.adapters.NoteAdapter.textColor;
import static ru.sberbank.lesson6.task.room.adapters.NoteAdapter.textSize;
import static ru.sberbank.lesson6.task.room.adapters.NoteEntry.NOTE_CONTENT;
import static ru.sberbank.lesson6.task.room.adapters.NoteEntry.NOTE_ID;
import static ru.sberbank.lesson6.task.room.utils.Helpers.getRealProgress;
import static ru.sberbank.lesson6.task.room.utils.Helpers.getSettingName;
