...
import ru.sberbank.lesson6.task.room.EditNoteActivity;
import ru.sberbank.lesson6.task.room.R;

import static android.graphics.PorterDuff.Mode.SRC_ATOP;
import static ru.sberbank.lesson6.task.room.MainActivity.EDIT_NOTE_ACTIVITY_REQUEST_CODE;
import static ru.sberbank.lesson6.task.room.adapters.NoteEntry.*;
